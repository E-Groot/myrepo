...
Comparing the mean tempo of both periods and looking further into the loudness variable{data-navmenu="Getting to know the selected corpus"}
=======================================
Column
-----------------------------------------------------------------------
### another box 
...
Loudness <- ggplot(corpus, aes(x = new_year, y = loudness, fill = new_year)) +
  ...
  scale_fill_manual(values = c("#FDB813", "#00A3E0")) +
...
Modern rap song analysis {.storyboard}
=======================================
